#!/usr/bin/env python
# print out ids of VM types supported by linode
# cli parameter 1 - optional, specifies string to match types against
import os
import sys
import linode_api4
...
for t in client.linode.types():
    if t.id.lower().__contains__(selection.lower()):
        print(t.id)
