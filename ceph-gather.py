...
OSD_ADMIN_SOCKET_GLOB = "/var/run/ceph/ceph-osd*.asok"
...
CREATE INDEX IF NOT EXISTS OSDStatus_TimestampIndex ON OSDStatus (timestamp);
"""
...
def main():
    ...
    for path in glob.glob(OSD_ADMIN_SOCKET_GLOB):
        daemons.append(OSDStatus(path, db))
